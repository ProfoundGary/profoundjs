      ...
      if (window.parent) {
        window.parent.showSwaggerUIRoute = function (routeInfo, delayLoadTime) {
          ...
          setTimeout(() => {
            ...
            url += "?method=" + routeInfo["method"] + "&path=" + routeInfo["path"] + "&modfile=" + routeInfo["modfile"] + "&routeKey=" + routeInfo["routeKey"];
            if (typeof routeInfo['dbgid'] === 'string' && routeInfo['dbgid'].length > 0) url += '&dbgid=' + routeInfo['dbgid'];
            if (routeInfo['plog'] != null) url += '&plog=' + routeInfo['plog'];
