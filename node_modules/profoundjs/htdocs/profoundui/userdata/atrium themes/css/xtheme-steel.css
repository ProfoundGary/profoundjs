...
.x-form-field-wrap .x-form-trigger {
  ...
  background-image: url("../images/steel/form/trigger.png");
  border-color: #aeb6be;
}
/* line 180, ../sass/azzurra-legacy/visual/_form.scss */
.x-form-field-wrap .x-form-date-trigger {
  background-image: url("../images/steel/form/date-trigger.png");
}
/* line 183, ../sass/azzurra-legacy/visual/_form.scss */
.x-form-field-wrap .x-form-clear-trigger {
  background-image: url("../images/steel/form/clear-trigger.png");
}
/* line 186, ../sass/azzurra-legacy/visual/_form.scss */
.x-form-field-wrap .x-form-search-trigger {
  background-image: url("../images/steel/form/search-trigger1.png");
}
...
.x-form-invalid-msg {
  ...
  background-image: url("../images/steel/shared/warning.gif");
}
...
.x-form-invalid-icon {
  background-image: url("../images/steel/form/exclamation.gif");
}
...
.x-btn-mc em.x-btn-arrow {
  background-image: url("../images/steel/button/arrow.gif");
}
...
.x-btn-over .x-btn-mc em.x-btn-arrow, .x-btn-click .x-btn-mc em.x-btn-arrow, .x-btn-menu-active .x-btn-mc em.x-btn-arrow, .x-btn-pressed .x-btn-mc em.x-btn-arrow {
  background-image: url("../images/steel/button/arrow-w.gif");
}

/* line 363, ../sass/azzurra-legacy/visual/_button.scss */
.x-btn-mc em.x-btn-split {
  background-image: url("../images/steel/button/s-arrow1.gif");
}

/* line 367, ../sass/azzurra-legacy/visual/_button.scss */
.x-btn-over .x-btn-mc em.x-btn-split, .x-btn-click .x-btn-mc em.x-btn-split, .x-btn-menu-active .x-btn-mc em.x-btn-split, .x-btn-pressed .x-btn-mc em.x-btn-split {
  background-image: url("../images/steel/button/s-arrow-o-w.gif");
}

/* line 371, ../sass/azzurra-legacy/visual/_button.scss */
.x-btn-mc em.x-btn-arrow-bottom {
  background-image: url("../images/steel/button/s-arrow-b-noline.gif");
}
...
.x-btn-over .x-btn-mc em.x-btn-arrow-bottom, .x-btn-click .x-btn-mc em.x-btn-arrow-bottom, .x-btn-menu-active .x-btn-mc em.x-btn-arrow-bottom, .x-btn-pressed .x-btn-mc em.x-btn-arrow-bottom {
  background-image: url("../images/steel/button/s-arrow-w-noline.gif");
}

/* line 378, ../sass/azzurra-legacy/visual/_button.scss */
.x-btn-mc em.x-btn-split-bottom {
  background-image: url("../images/steel/button/s-arrow-b1.gif");
}

/* line 382, ../sass/azzurra-legacy/visual/_button.scss */
.x-btn-over .x-btn-mc em.x-btn-split-bottom, .x-btn-click .x-btn-mc em.x-btn-split-bottom, .x-btn-menu-active .x-btn-mc em.x-btn-split-bottom, .x-btn-pressed .x-btn-mc em.x-btn-split-bottom {
  background-image: url("../images/steel/button/s-arrow-bo-white1.gif");
}
...
.x-tbar-page-first {
  background-image: url("../images/steel/grid/pagingbar-sprite.png") !important;
  background-position: 0 0 !important;
}
...
.x-toolbar .x-btn-mc em.x-btn-split {
  background-image: url("../images/steel/button/s-arrow-noline.gif");
}
...
.x-toolbar .x-btn-menu-active .x-btn-mc em.x-btn-split-bottom, .x-toolbar .x-btn-pressed .x-btn-mc em.x-btn-split-bottom {
  background-image: url("../images/steel/button/s-arrow-b.gif");
}

/*Fixes weird line under 'Open' icon */
.x-toolbar .x-btn-over .x-btn-mc em.x-btn-split-bottom.x-unselectable,
...
.x-toolbar-more-icon {
  background-image: url("../images/steel/toolbar/more.gif") !important;
}
...
.x-grid-row-loading {
  background-color: #fff;
  background-image: url("../images/steel/shared/loading-balls.gif");
}
...
.x-grid3-header-pop-inner {
  ...
  background-image: url("../images/steel/grid/hd-pop.gif");
}

/* line 294, ../sass/azzurra-legacy/visual/_grid.scss */
.sort-asc .x-grid3-sort-icon {
  background-image: url("../images/steel/grid/sort_asc_gray.gif");
}

/* line 298, ../sass/azzurra-legacy/visual/_grid.scss */
.sort-desc .x-grid3-sort-icon {
  background-image: url("../images/steel/grid/sort_desc_gray.gif");
}

/* line 306, ../sass/azzurra-legacy/visual/_grid.scss */
.x-grid3-split {
  background-image: url("../images/steel/grid/grid-split.gif");
}

/* line 314, ../sass/azzurra-legacy/visual/_grid.scss */
.x-dd-drag-proxy .x-grid3-hd-inner {
  background-color: #ebf3fd;
  background-image: url("../images/steel/grid/grid3-hrow-over.gif");
  border-color: #aaccf6;
}

/* line 320, ../sass/azzurra-legacy/visual/_grid.scss */
.col-move-top {
  background-image: url("../images/steel/grid/col-move-top.gif");
}

/* line 324, ../sass/azzurra-legacy/visual/_grid.scss */
.col-move-bottom {
  background-image: url("../images/steel/grid/col-move-bottom.gif");
}

/* line 328, ../sass/azzurra-legacy/visual/_grid.scss */
td.grid-hd-group-cell {
  background: url("../images/steel/grid/grid3-hrow.gif") repeat-x bottom;
}
...
.x-grid3-locked td.x-grid3-row-marker, .x-grid3-locked .x-grid3-row-selected td.x-grid3-row-marker {
  ...
  background-image: url("../images/steel/grid/grid-hrow.gif") !important;
  color: #000;
...
.x-grid3-dirty-cell {
  background-image: url("../images/steel/grid/dirty.gif");
}
...
.x-props-grid .x-grid3-td-name .x-grid3-cell-inner {
  background-image: url("../images/steel/grid/grid3-special-col-bg.gif") !important;
  color: #000 !important;
}
...
.xg-hmenu-sort-asc .x-menu-item-icon {
  background-image: url("../images/steel/grid/hmenu-asc.png");
}

/* line 392, ../sass/azzurra-legacy/visual/_grid.scss */
.xg-hmenu-sort-desc .x-menu-item-icon {
  background-image: url("../images/steel/grid/hmenu-desc.png");
}

/* line 396, ../sass/azzurra-legacy/visual/_grid.scss */
.xg-hmenu-lock .x-menu-item-icon {
  background-image: url("../images/steel/grid/hmenu-lock.gif");
}

/* line 400, ../sass/azzurra-legacy/visual/_grid.scss */
.xg-hmenu-unlock .x-menu-item-icon {
  background-image: url("../images/steel/grid/hmenu-unlock.gif");
}

/* line 404, ../sass/azzurra-legacy/visual/_grid.scss */
.x-grid3-hd-btn {
  background-color: #c3daf9;
  background-image: url("../images/steel/grid/grid3-hd-btn.gif");
}
...
.x-grid3-row-expander {
  background-image: url("../images/steel/grid/row-expand-sprite1.gif");
}
...
.x-grid3-row-checker, .x-grid3-hd-checker {
  background-image: url("../images/steel/grid/row-check-sprite1.gif");
}
...
.x-grid3-body .x-grid3-td-row-icon {
  background-image: url("../images/steel/grid/grid3-special-col-bg.gif");
}
...
.x-grid3-check-col {
  background-image: url("../images/steel/menu/unchecked.gif");
}

/* line 464, ../sass/azzurra-legacy/visual/_grid.scss */
.x-grid3-check-col-on {
  background-image: url("../images/steel/menu/checked.gif");
}
...
.x-grid-group-hd div.x-grid-group-title {
  background-image: url("../images/steel/grid/group-collapse1.gif");
  color: #333;
  font: normal 12px "Segoe UI", tahoma, arial, verdana, sans-serif;
}
...
.x-grid-group-collapsed .x-grid-group-hd div.x-grid-group-title {
  background-image: url("../images/steel/grid/group-expand1.gif");
}

/* line 487, ../sass/azzurra-legacy/visual/_grid.scss */
.x-group-by-icon {
  background-image: url("../images/steel/grid/group-by.gif");
}

/* line 491, ../sass/azzurra-legacy/visual/_grid.scss */
.x-cols-icon {
  background-image: url("../images/steel/grid/columns.gif");
}
...
.x-pivotgrid .x-grid3-header-offset table td {
  background: url("../images/steel/grid/grid3-hrow.gif") repeat-x 50% 100%;
  border-left: 1px solid;
  border-right: 1px solid;
  border-left-color: #EEE;
...
.x-dd-drop-nodrop .x-dd-drop-icon {
  background-image: url("../images/steel/dd/drop-no.gif");
}

/* line 14, ../sass/azzurra-legacy/visual/_dd.scss */
.x-dd-drop-ok .x-dd-drop-icon {
  background-image: url("../images/steel/dd/drop-yes.gif");
}

/* line 18, ../sass/azzurra-legacy/visual/_dd.scss */
.x-dd-drop-ok-add .x-dd-drop-icon {
  background-image: url("../images/steel/dd/drop-add.gif");
}
...
.x-tree-node-expanded .x-tree-node-icon {
  background-image: url("../images/steel/tree/icons-small.png");
...
.x-tree-lines .x-tree-elbow {
  background-image: url("../images/steel/tree/all-elbows-small.png");
  background-position: 0 center;
}
...
.x-tree-node-loading .x-tree-node-icon {
  background-image: url("../images/steel/tree/loading.gif") !important;
}
...
.x-tree-arrows .x-tree-elbow-plus {
  background-image: url("../images/steel/tree/arrows.gif");
}
...
.x-tree-drop-ok-append .x-dd-drop-icon {
  background-image: url("../images/steel/tree/drop-add.gif");
}

/* line 303, ../sass/azzurra-legacy/visual/_tree.scss */
.x-tree-drop-ok-above .x-dd-drop-icon {
  background-image: url("../images/steel/tree/drop-over.gif");
}

/* line 307, ../sass/azzurra-legacy/visual/_tree.scss */
.x-tree-drop-ok-below .x-dd-drop-icon {
  background-image: url("../images/steel/tree/drop-under.gif");
}

/* line 311, ../sass/azzurra-legacy/visual/_tree.scss */
.x-tree-drop-ok-between .x-dd-drop-icon {
  background-image: url("../images/steel/tree/drop-between.gif");
}
...
.x-date-middle .x-btn-mc em.x-btn-arrow {
  background-image: url("../images/steel/toolbar/btn-arrow-light.gif");
}

/* line 359, ../sass/azzurra-legacy/visual/_date-picker.scss */
.x-date-right a {
  background-image: url("../images/steel/shared/right-btn.gif");
}

/* line 363, ../sass/azzurra-legacy/visual/_date-picker.scss */
.x-date-left a {
  background-image: url("../images/steel/shared/left-btn.gif");
}
...
.x-date-mp-ybtn a {
  background-image: url("../images/steel/panel/tool-sprite.png");
}
...
.x-tip .x-tip-close {
  background-image: url("../images/steel/qtip/close.gif");
}

/* line 7, ../sass/azzurra-legacy/visual/_qtips.scss */
.x-tip .x-tip-tc, .x-tip .x-tip-tl, .x-tip .x-tip-tr, .x-tip .x-tip-bc, .x-tip .x-tip-bl, .x-tip .x-tip-br, .x-tip .x-tip-ml, .x-tip .x-tip-mr {
  /*background-image: url("../images/steel/qtip/tip-sprite.gif");*/
  background-image: none;
  background-color: #2980b9;
...
.x-form-invalid-tip .x-tip-bl, .x-form-invalid-tip .x-tip-br, .x-form-invalid-tip .x-tip-ml, .x-form-invalid-tip .x-tip-mr {
  background-image: url("../images/steel/form/error-tip-corners.gif");
}
...
.x-tip-anchor {
  background-image: url("../images/steel/qtip/tip-anchor-sprite.gif");
}
...
.x-menu-item-arrow {
  background-image: url("../images/steel/menu/menu-parent.gif");
}
...
.x-menu-item-checked .x-menu-group-item .x-menu-item-icon {
  background-image: url("../images/steel/menu/group-checked.gif");
}
...
.x-menu-scroller-top {
  background-image: url("../images/steel/layout/mini-top.gif");
}

/* line 173, ../sass/azzurra-legacy/visual/_menu.scss */
.x-menu-scroller-bottom {
  background-image: url("../images/steel/layout/mini-bottom.gif");
}
...
.x-box-tl {
  background-image: url("../images/steel/box/corners.gif");
}

/* line 11, ../sass/azzurra-legacy/visual/_box.scss */
.x-box-tc {
  background-image: url("../images/steel/box/tb.gif");
}
...
.x-box-ml {
  background-image: url("../images/steel/box/l.gif");
}
...
.x-box-mr {
  background-image: url("../images/steel/box/r.gif");
}
...
.x-box-blue .x-box-bl, .x-box-blue .x-box-br, .x-box-blue .x-box-tl, .x-box-blue .x-box-tr {
  background-image: url("../images/steel/box/corners-blue.gif");
}

/* line 56, ../sass/azzurra-legacy/visual/_box.scss */
.x-box-blue .x-box-bc, .x-box-blue .x-box-mc, .x-box-blue .x-box-tc {
  background-image: url("../images/steel/box/tb-blue.gif");
}
...
.x-box-blue .x-box-ml {
  background-image: url("../images/steel/box/l-gray.gif");
}

/* line 72, ../sass/azzurra-legacy/visual/_box.scss */
.x-box-blue .x-box-mr {
  background-image: url("../images/steel/box/r-gray.gif");
}
...
/* line 66, ../sass/azzurra-legacy/visual/_panel.scss */
.x-panel .x-panel-header-text:xafter {
  content: "Azzurra Theme Trial";
  position: absolute;
  top: 6px;
  right: 20px;
...
/* line 88, ../sass/azzurra-legacy/visual/_window.scss */
.x-window .x-window-header-text:xafter {
  content: "Azzurra Theme Trial";
  position: absolute;
  top: 4px;
  right: 30px;
...
/* line 88, ../sass/azzurra-legacy/visual/_window.scss */
.x-panel-ghost .x-window-header-text:xafter {
  content: "Azzurra Theme Trial";
  position: absolute;
  top: 4px;
  right: 30px;
...
.x-slider-horz, .x-slider-horz .x-slider-end, .x-slider-horz .x-slider-inner {
  background-image: url("../images/steel/slider/slider-bg.png");
}

/* line 7, ../sass/azzurra-legacy/visual/_slider.scss */
.x-slider-horz .x-slider-thumb {
  background-image: url("../images/steel/slider/slider-thumb.png");
}

/* line 11, ../sass/azzurra-legacy/visual/_slider.scss */
.x-slider-vert, .x-slider-vert .x-slider-end, .x-slider-vert .x-slider-inner {
  background-image: url("../images/steel/slider/slider-v-bg.png");
}

/* line 15, ../sass/azzurra-legacy/visual/_slider.scss */
.x-slider-vert .x-slider-thumb {
  background-image: url("../images/steel/slider/slider-v-thumb.png");
}
...
.x-window-dlg .ext-mb-info {
  background-image: url("../images/steel/window/icon-info.png"); 
  /*margin-left: 10px;*/
  /*width: 22px;*/
}
...
.x-window-dlg .ext-mb-warning {
  background-image: url("../images/steel/window/icon-warning.gif");
}

/* line 23, ../sass/azzurra-legacy/visual/_dialog.scss */
.x-window-dlg .ext-mb-question {
  background-image: url("../images/steel/window/icon-question.gif");
}
...
/* line 66, ../sass/azzurra-legacy/visual/_panel.scss */
.x-panel.blue-panel .x-panel-header-text:xafter {
  content: "Azzurra Theme Trial";
  position: absolute;
  top: 6px;
  right: 20px;
...
/* line 66, ../sass/azzurra-legacy/visual/_panel.scss */
.active-window .x-panel.blue-panel-active .x-panel-header-text:xafter {
  content: "Azzurra Theme Trial";
  position: absolute;
  top: 6px;
  right: 20px;
...
/* line 88, ../sass/azzurra-legacy/visual/_window.scss */
.x-window.blue-window-active.active-window .x-window-header-text:xafter {
  content: "Azzurra Theme Trial";
  position: absolute;
  top: 4px;
  right: 30px;
...
/* line 88, ../sass/azzurra-legacy/visual/_window.scss */
.x-window.blue-window .x-window-header-text:xafter {
  content: "Azzurra Theme Trial";
  position: absolute;
  top: 4px;
  right: 30px;
