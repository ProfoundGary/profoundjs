...
.x-grid-group-hd div.x-grid-group-title {
  background: transparent no-repeat 3px 7px;
...
.x-grid-group-hd div.x-grid-group-title {
  ...
  color: #333;
  font: bold 14px "Segoe UI", tahoma, arial, verdana, sans-serif;
}
...
.x-window-dlg .ext-mb-error {
  background-image: url("../images/azzurra-legacy/window/icon-error.png");
}
...
.x-tree-no-lines .x-tree-elbow-minus {
	float: left;
    background-image: url("../images/azzurra-legacy/panel/minus.png");
}

.x-tree-no-lines .x-tree-elbow-plus {
	float: left;
    background-image: url("../images/azzurra-legacy/panel/plus.png");
}
